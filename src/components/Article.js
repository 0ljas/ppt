          ...
          <Grid container className={classes.root}>
            ...
            <Grid item xs={6} className={classes.right}>
              ...
              >
                ...
                контемпорари. Лондон - удивительный город, здесь всегда есть
                место экспериментам и лекго найти единомышленников. А еще можно
                одеваться как хочешь, и никто не посмотрит на тебя с удивлением.
                Я чувствую себя свободной, когда танцую, - не нужно думать о
                проблемах, обо всем, что происходит в жизни я обретаю настоящую
                легкость...
              </Typography>
